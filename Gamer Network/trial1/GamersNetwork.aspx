<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GamersNetwork.aspx.cs" Inherits="trial1.GamersNetwork" %>
...
<body background="Tom-Clancys-The-Division-2015-Game-Wallpaper.jpg">
    ...
    <form id="form1" runat="server">
        ...
        <asp:Button ID="updateme" runat="server" Text="Update my Profile" OnClick="updateme_Click" Width="153px" />
        &nbsp;<asp:Button ID="friendsme" runat="server" Text="My Friends" OnClick="friendsme_Click"/>
        <asp:Button ID="friendsnotme" runat="server" Text="Pending Friends" OnClick="friendsnotme_Click" />
        <asp:Button ID="inbox" runat="server" Text="Inbox" OnClick="inbox_Click" />
        <asp:Button ID="addfriends" runat="server" Text="Add Friends" OnClick="addfriends_Click" />
        <asp:Button ID="FriendRequestSent" runat="server" Text="Friend Request Sent" OnClick="FriendRequestSent_Click" />
...
div {
 ...
 border:solid;
        ...
        <div>
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <asp:GridView ID="gv" CssClass="table table" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" OnRowEditing="gv_RowEditing" >
