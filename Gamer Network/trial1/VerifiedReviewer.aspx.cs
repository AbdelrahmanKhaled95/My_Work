...
namespace trial1
{
    public partial class VerifiedReviewer : System.Web.UI.Page
    {
        private static String email;

        public static String Email
        {
            get { return VerifiedReviewer.email; }
            set { VerifiedReviewer.email = value; }
        }
        ...
        protected void done_Click(object sender, EventArgs e)
        {
            ...
            int exp = Int32.Parse(birth.Text);
            ...
            using (SqlConnection conn = new SqlConnection(connectionfromconfiguration.ConnectionString))
            {
                ...
                SqlCommand cmd = new SqlCommand("insertVerifiedReviewer", conn);
