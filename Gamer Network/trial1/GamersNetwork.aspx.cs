...
namespace trial1
{
    public partial class GamersNetwork : System.Web.UI.Page
    {
        private static String find;

        public static String Find
        {
            get { return GamersNetwork.find; }
            set { GamersNetwork.find = value; }
        }
        ...
        private void binddatatogridview()
        {
            ...
            {
                conn.Open();
                SqlCommand cmd2 = new SqlCommand("findmenormal", conn);
        ...
        protected void updateme_Click(object sender, EventArgs e)
        {
                    ...
                    Response.Redirect("NormalUpdate.aspx");
            }
        
        protected void friendsme_Click(object sender, EventArgs e)
        {
            Response.Redirect("Myfriends");
...
//////////////////////////////////////////////////////////////////////////
        ...
        protected void addfriends_Click(object sender, EventArgs e)
        {
        ...
        protected void FriendRequestSent_Click(object sender, EventArgs e)
        {
            Response.Redirect("FriendRequestSent");
        }
